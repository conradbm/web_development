...
function appendText(btn) {
    ...
    if(btn.id == "education-btn" && (edu_btn == true)){
        ...
        $('#appendHere').append("<ul><li><h4>Academic</h4><ul><li>B.S. in Computer Science from <a href='http://cs.iupui.edu' target='_blank'>Purdue University</a>.</li><li>Minor in Mathematics.</li></li></ul></ul><ul><li><h4>Professional</h4><ul><li>Developed, refined, and innovated new solutions to large scale software projects in an internship with the <a href='http://www.trac.army.mil/' target='_blank'>Department of Defense</a>.</li></li></ul>");
        
        
        /*
<ul id="education_appended">
<li>B.S. in Computer Science from Purdue University.</li>
<li>Minor in Mathematics.</li>
<li>Developed, refined, and innovated new solutions to large scale software projects 
in an internship with the Department of Defense.</li>
</ul>
        */
