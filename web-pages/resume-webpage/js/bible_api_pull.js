                ...
                if (json.type == 'verse'){
                    ...
                    var output = '';
                        jQuery.each(json.book, function(index, value) {
                            output_book += value.book_name;
                            output_chapter += value.chapter_nr;
                            output += '<center><b>'+value.book_name+' '+value.chapter_nr+'</b></center><br/><p class="'+direction+'">';
                            jQuery.each(value.chapter, function(index, value) {
                                
                                output_raw += value.verse_nr;
                                output_raw += " ";
                                output_raw += value.verse;
                                output_raw += "\n";
                    ...
                    request = $.ajax({
                        url: "../php/storage.php",
                        type: "post",
                        data: {book: output_book,
                              chapter: output_chapter,
                              chapterText: output_raw},
                        success:function(data_output_from_php){
